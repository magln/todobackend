...
release:
	docker-compose -p $(REL_PROJECT) -f $(REL_COMPOSITE_FILE) build
	docker-compose -p $(REL_PROJECT) -f $(REL_COMPOSITE_FILE) up agent
...
clean:
	...
	docker-compose -p $(REL_PROJECT) -f $(REL_COMPOSITE_FILE) rm -f	